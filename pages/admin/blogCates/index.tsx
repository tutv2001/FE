...
import BlogCateList from '../../../component/admin/blogCate/ListBlogCate';
import { AdminLayout } from '../../../layouts';

type Props = {}

const BlogCate = (props: Props) => {
    return (
        <div>
            <>
                <Head>
                ...
                <header className="z-10 fixed top-0 eft-0 md:left-60 right-0 px-4 py-1.5 bg-white shadow-[0_1px_2px_rgba(0,0,0,0.1)] flex items-center justify-between">
                    <div className="flex items-center text-sm text-gray-600">
                        ...
                        <span>DS Danh mục bài viết</span>
                    </div>
                    <Link href="/admin/blogCates/add">
                        <button
                            type="button"
...
BlogCate.getLayout = (page: ReactElement) => <AdminLayout>{page}</AdminLayout>;
