...
import { getprdColor, updateprdColor } from "../../../../redux/prdColorSlice";
...
const EditprdColor: NextPageWithLayout = (props: Props) => {
    ...
    const onSubmit: SubmitHandler<Inputs> = async (values: Inputs) => {
        try {          
            await dispatch(updateprdColor(values)).unwrap();
    ...
    useEffect(() => {
        (async () => {
            try {
                const user = await dispatch(getprdColor(id)).unwrap();
...
EditprdColor.getLayout = (page: ReactElement) => <AdminLayout>{page}</AdminLayout>;

export default EditprdColor;
